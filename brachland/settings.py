"""
Django settings for brachland project.
"""
...
ALLOWED_HOSTS = ['juntagrico.solawi-brachland.ch','brachland.juntagrico.science', 'localhost',]
...
ROOT_URLCONF = 'brachland.urls'

DATABASES = {
    'default': {
        'ENGINE': os.environ.get('JUNTAGRICO_DATABASE_ENGINE','django.db.backends.sqlite3'), 
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','brachland.db'), 
...
WSGI_APPLICATION = 'brachland.wsgi.application'
...
"""
     juntagrico Settings
"""
ORGANISATION_NAME = "Solawi Brachland"
ORGANISATION_LONG_NAME = "Solawi Brachland"
ORGANISATION_ADDRESS = {"name":"Solawi Brachland", 
            "street" : "Brachstrasse",
            "number" : "12",
            "zip" : "8608",
            "city" : "Bubikon",
